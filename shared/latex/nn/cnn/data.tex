...
\begin{frame}{Classification}
  \V{["tikz/ml/vision/classification", "tw", 1.0] | image}
\end{frame}

\begin{frame}{Super résolution}
  \V{["tikz/ml/vision/super-resolution", "tw", 1.0] | image}
\end{frame}

\begin{frame}{Inpainting}
  \V{["tikz/ml/vision/inpainting", "tw", 1.0] | image}
\end{frame}

\begin{frame}{Détection d'anomalie}
  \V{["tikz/ml/vision/anomaly-detection", "tw", 1.0] | image}
\end{frame}
