\begin{frame}{A vast field}
  \V{["data-science-nzmog-en", "tw", 0.9] | image}
\end{frame}
...
\begin{frame}{Example --- Reinforcement learning}
  \V{["car-dashboard", "tw", 0.8] | image}
\end{frame}

\begin{frame}{Domain topology}
  \V{["ml-illustration-en", "tw", 0.8] | image}
\end{frame}
