\begin{frame}{A vast field}
  \V{["img/data-science-nzmog-en", "tw", 0.9] | image}
\end{frame}
...
\begin{frame}{Reinforcement learning}
  ...
  \begin{minipage}[l]{0.39\linewidth}
    \V{["img/echec", "tw", 0.8] | image}
  \end{minipage}
  \begin{minipage}[l]{0.59\linewidth}
    \V{["img/darpa-urban-challenge", "tw", 0.75] | image}
  \end{minipage}
\end{frame}
