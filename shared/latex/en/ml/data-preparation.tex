...
\begin{frame}{Plotting — Count plot}
  \V{"img/countplot-nzmog" | image("th", 0.7, "en")}
\end{frame}

\begin{frame}{Plotting — Histogram}
  \V{"plt/histogram-en" | image("th", 0.7)}
\end{frame}

\begin{frame}{Plotting — Q-Q plot}
  \V{"plt/qq-plot-en" | image("th", 0.5)}
...
\begin{frame}{Plotting — Bar plot}
  \V{"plt/bar-plot-en" | image("th", 0.7)}
\end{frame}

\begin{frame}{Plotting — Scatter plot}
  \V{"plt/scatter-plot-en" | image("th", 0.7)}
\end{frame}

\begin{frame}{Plotting — Violin plot}
  \V{"plt/violin-plot-en" | image("th", 0.7)}
\end{frame}

\begin{frame}{Plotting — Pair plot}
  \V{"img/pairplot-nzmog" | image("th", 0.7, "en")}
\end{frame}

\begin{frame}{Plotting — Correlation matrix}
  \V{"plt/corrmat-en" | image("th", 0.7)}
\end{frame}
