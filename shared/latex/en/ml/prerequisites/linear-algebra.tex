...
\begin{frame}{Applying linear transformations to a dataset}
  ...
  \V{"img/linear-algebra-en" | image("tw", 0.7)}
...
\begin{frame}{Applying linear transformations to a dataset}
  ...
  \V{"img/linear-algebra-run-en" | image("tw", 0.7)}
...
\begin{frame}{Mnemonic}
  ...
  \V{"img/linear-algebra-en" | image("tw", 1)}
\end{frame}

\begin{frame}{Mnemonic}

  \V{"img/linear-algebra-run-en" | image("th", 0.8)}
\end{frame}
...
\begin{frame}{Linear transformation example}
  ...
  \V{"img/linear-transformation" | image("tw", 0.5)}
  \[
    \begin{aligned}
