...
\begin{frame}{Plotting — Count plot}
  \V{["countplot-nzmog", "th", 0.7, "en"] | image}
\end{frame}

\begin{frame}{Plotting — Dist plot}
  \V{["distplot-nzmog", "th", 0.7, "en"] | image}
\end{frame}

\begin{frame}{Plotting — Q-Q plot}
  \V{["qqplot-nzmog", "th", 0.5, "en"] | image}
...
\begin{frame}{Plotting — Bar plot}
  \V{["barplot-nzmog", "th", 0.7, "en"] | image}
\end{frame}

\begin{frame}{Plotting — Scatter plot}
  \V{["scatter-nzmog", "th", 0.7, "en"] | image}
\end{frame}

\begin{frame}{Plotting — Violin plot}
  \V{["violinplot-nzmog", "th", 0.7, "en"] | image}
\end{frame}

\begin{frame}{Plotting — Pair plot}
  \V{["pairplot-nzmog", "th", 0.7, "en"] | image}
\end{frame}

\begin{frame}{Plotting — Correlation matrix}
  \V{["corrmat-nzmog", "th", 0.7, "en"] | image}
\end{frame}
