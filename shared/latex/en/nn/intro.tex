...
\begin{frame}{Relation with linear regression}
  \V{["separable-problem-linear-solution-nzmog", "tw", 0.9, "en"] | image}
\end{frame}

\begin{frame}{Need to go beyond linear regression}
  \V{["xor-nzmog", "tw", 0.9, "en"] | image}
\end{frame}

\begin{frame}{(Weak) relation with biology}
  \V{["biological-neuron", "tw", 1, "en"] | image}
\end{frame}

\begin{frame}{Artificial neuron model}
  \V{["neural-networks/model-en", "tw", 0.9] | image}
\end{frame}
