...
\begin{frame}{Relation with linear regression}
  \V{"img/separable-problem-linear-solution-nzmog" | image("tw", 0.9, "en")}
\end{frame}

\begin{frame}{Need to go beyond linear regression}
  \V{"img/xor-nzmog" | image("tw", 0.9, "en")}
\end{frame}
...
\begin{frame}{Activation functions --- Sigmoid}
  \begin{center}
    \V{"tikz/activations/sigmoid" | image("tw", 1, "en")}
  \end{center}
...
\begin{frame}{Activation functions --- Tanh}
  \begin{center}
    \V{"tikz/activations/tanh" | image("th", 0.3, "en")}
  \end{center}
...
\begin{frame}{Activation functions--- ReLU}
  \begin{center}
    \V{"tikz/activations/relu" | image("th", 0.3, "en")}
  \end{center}
...
\begin{frame}{Activation functions --- Function approximation}
  \centering
    \V{"tikz/activations/approximation" | image("tw", 0.8, "en")}
  {\small
    \begin{align*}
