\begin{frame}{Relation with linear regression}
  \V{["img/regression-10", "tw", 0.9] | image}
\end{frame}

\begin{frame}{Relation with linear regression}
  \V{["img/separable-problem-linear-solution-nzmog", "tw", 0.9, "en"] | image}
\end{frame}

\begin{frame}{Need to go beyond linear regression}
  \V{["img/xor-nzmog", "tw", 0.9, "en"] | image}
\end{frame}

\begin{frame}{(Weak) relation with biology}
  \V{["img/biological-neuron", "tw", 1, "en"] | image}
\end{frame}

\begin{frame}{Artificial neuron model}
  \V{["tikz/neural-networks/model-en", "tw", 0.9] | image}
\end{frame}
...
\begin{frame}{Shallow network}
  \centering
  \V{["tikz/neural-networks/shallow-ff-en", "tw", 1] | image}
\end{frame}

\begin{frame}{One hidden layer network}
  \centering
  \V{["tikz/neural-networks/one-hidden-layer-ff-en", "tw", 1] | image}
\end{frame}

\begin{frame}{Deep network}
  \centering
  \V{["tikz/neural-networks/deep-ff-en", "tw", 1] | image}
\end{frame}

\begin{frame}{A theoretically interesting model}
  \textbf{Kurt Hornik, 1991:} Universal approximation theorem
  \V{["tikz/activations/approximation", "tw", 1, "en"] | image}
...
\begin{frame}{Activation functions --- Sigmoid}
  \begin{center}
    \V{["tikz/activations/sigmoid", "tw", 1, "en"] | image}
  \end{center}
...
\begin{frame}{Activation functions --- Tanh}
  \begin{center}
    \V{["tikz/activations/tanh", "th", 0.3, "en"] | image}
  \end{center}
...
\begin{frame}{Activation functions--- ReLU}
  \begin{center}
    \V{["tikz/activations/relu", "th", 0.3, "en"] | image}
  \end{center}
...
\begin{frame}{Activation functions --- Function approximation}
  \centering
    \V{["tikz/activations/approximation", "tw", 0.8, "en"] | image}
  {\small
    \begin{align*}
