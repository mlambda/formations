...
\begin{frame}{Convolution}
  ...
  \V{["img/d2l/correlation", "tw", 0.8, "en"] | image}
\end{frame}
...
\begin{frame}{Convolution on multiple channels}
  ...
  \V{["img/d2l/conv-multi-in", "th", 0.3, "en"] | image}
...
\begin{frame}{Convolution padding}
  ...
  \V{["img/d2l/conv-pad", "th", 0.4, "en"] | image}
...
\begin{frame}{Convolution stride}
  ...
  \V{["img/d2l/conv-stride", "th", 0.4, "en"] | image}
...
\begin{frame}{Pooling}
  ...
  \V{["img/d2l/pooling", "tw", 0.8, "en"] | image}
