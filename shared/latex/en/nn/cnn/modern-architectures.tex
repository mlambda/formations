...
\begin{frame}{ResNet --- Residual blocks}
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.5\textwidth}
      \V{["d2l/residual-block", "tw", 1, "en"] | image}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{ResNet --- ResNet blocks}
  ...
  \V{["d2l/resnet-block", "th", 0.5, "en"] | image}
\end{frame}
...
\begin{frame}{DenseNet --- Block}
  ...
  \V{["d2l/densenet-block", "th", 0.5, "en"] | image}
\end{frame}
