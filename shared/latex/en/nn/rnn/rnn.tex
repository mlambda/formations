...
\begin{frame}{Prediction of a single output}
  ...
  \begin{figure}
    \centering
    \V{["neural-networks/rnn/lastoutput-en", "th", 0.7] | image}
  \end{figure}
\end{frame}

\begin{frame}{Prediction of one output per input}
  \V{["neural-networks/rnn/alloutputs-en", "tw", 0.5] | image}
\end{frame}

\begin{frame}{Prediction of an arbitrary number of outputs}
  \V{["neural-networks/rnn/seq2seq", "tw", 1] | image}
\end{frame}

\begin{frame}{Vanishing gradient problem: recurrence edition}
  \V{["optimization/vanishing-gradients-rnn-en", "tw", 0.7] | image}
\end{frame}
