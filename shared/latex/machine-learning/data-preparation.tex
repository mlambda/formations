...
\begin{frame}{Outils — count plot}
  \V{["countplot-nzmog", "th", 0.7] | image}
\end{frame}

\begin{frame}{Outils — dist plot}
  \V{["distplot-nzmog", "th", 0.7] | image}
\end{frame}

\begin{frame}{Outils — qq plot}
  \V{["qqplot-nzmog", "th", 0.5] | image}
...
\begin{frame}{Outils — bar plot}
  \V{["barplot-nzmog", "th", 0.7] | image}
\end{frame}

\begin{frame}{Outils — scatter plot}
  \V{["scatter-nzmog", "th", 0.7] | image}
\end{frame}

\begin{frame}{Outils — violin plot}
  \V{["violinplot-nzmog", "th", 0.7] | image}
\end{frame}

\begin{frame}{Outils — pair plot}
  \V{["pairplot-nzmog", "th", 0.7] | image}
\end{frame}

\begin{frame}{Outils — correlation matrix}
  \V{["corrmat-nzmog", "th", 0.7] | image}
\end{frame}
