...
\begin{frame}{Outils — count plot}
  \V{["countplot-nzmog", "tw", 1] | image}
\end{frame}

\begin{frame}{Outils — dist plot}
  \V{["distplot-nzmog", "tw", 1] | image}
\end{frame}

\begin{frame}{Outils — qq plot}
  \V{["qqplot-nzmog", "tw", 1] | image}
...
\begin{frame}{Outils — bar plot}
  \V{["barplot-nzmog", "tw", 1] | image}
\end{frame}

\begin{frame}{Outils — scatter plot}
  \V{["scatter-nzmog", "tw", 0.7] | image}
\end{frame}

\begin{frame}{Outils — violin plot}
  \V{["violinplot-nzmog", "tw", 1] | image}
\end{frame}

\begin{frame}{Outils — pair plot}
  \V{["pairplot-nzmog", "tw", 0.65] | image}
\end{frame}

\begin{frame}{Outils — correlation matrix}
  \V{["corrmat-nzmog", "tw", 0.8] | image}
\end{frame}
