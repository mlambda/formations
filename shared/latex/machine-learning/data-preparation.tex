...
\begin{frame}{Outils — count plot}
  \V{["countplot", "tw", 1] | image}
\end{frame}

\begin{frame}{Outils — dist plot}
  \V{["distplot", "tw", 1] | image}
\end{frame}
