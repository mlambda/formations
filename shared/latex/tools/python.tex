...
\begin{frame}
  \frametitle{Points forts/faibles}
...
\begin{frame}
  ...
  \inputminted[linenos,fontsize=\small,bgcolor=pythonbg]{python}{code/python-blocs.py}
  \inputminted[linenos,fontsize=\small,bgcolor=returnbg]{python}{code/python-blocs.txt}
\end{frame}
