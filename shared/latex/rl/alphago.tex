...
\begin{frame}{Réseau de value}
  ...
  \V{["alphago-value", "tw", 1] | image}
  \end{minipage}\hfill
\end{frame}

\begin{frame}{Réseau de policy}
  \begin{minipage}[c]{0.50\linewidth}
    \V{["alphago-policy", "th", 0.8] | image}
  \end{minipage}\hfill
...
\begin{frame}{AlphaGo Zero}
  ...
  \end{description}
  \onslide<+->{\V{["alphagozero-lerningcurve", "tw", 1] | image}}
\end{frame}
