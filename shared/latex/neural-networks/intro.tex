...
\begin{frame}{Lien (ténu) avec la biologie}
  \imgtw[0.9][Diagram of a Neuron, Wikimedia Commons User:Dhp1080, CC BY-SA 3.0]{biological-neuron}
\end{frame}
...
\begin{frame}{Réseau sans couche cachée}
  \centering
  \imgtw{neural-networks/shallow-ff}
\end{frame}

\begin{frame}{Réseau avec une couche cachée}
  \centering
  \imgtw{neural-networks/one-hidden-layer-ff}
\end{frame}

\begin{frame}{Réseau profond}
  \centering
  \imgtw{neural-networks/deep-ff}
\end{frame}
...
\begin{frame}{Fonctions d'activation --- Approximation d'une fonction}
  \centering
    \imgtw{activations/approximation}
  {\small
    \begin{align*}
