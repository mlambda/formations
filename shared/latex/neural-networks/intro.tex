\begin{frame}{Lien avec la régression linéaire}
  \imgtw{regression-10}{0.9}
\end{frame}

\begin{frame}{Lien avec la régression linéaire}
  \imgtw{separable-problem-linear-solution}{0.9}
\end{frame}
...
\begin{frame}{Lien (ténu) avec la biologie}
  \imgtw[Diagram of a Neuron, Wikimedia Commons User:Dhp1080, CC BY-SA 3.]{biological-neuron}{0.9}
\end{frame}

\begin{frame}{Modélisation d'un neurone}
  \imgtw{neuron-model}{0.9}
\end{frame}
...
\begin{frame}{Fonctions d'activation --- Approximation d'une fonction}
  \centering
    \imgtw{activations/approximation}{1}
  {\small
    \begin{align*}
