...
\begin{frame}{Utilisation}
  ...
  \mintedpycode{python/pytest/simple_usage}
\end{frame}
...
\begin{frame}{Utilisation d'une fixture}
  \mintedpycode{python/pytest/simple_fixture}
\end{frame}
...
\begin{frame}{Extensions}
  \bluelink{https://docs.pytest.org/en/latest/plugin_list.html}{Beaucoup de plugins disponibles.}
\end{frame}
