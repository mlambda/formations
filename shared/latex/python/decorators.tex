...
\begin{frame}{Exemple}
  \mintedpycode{python/decorators/example}
...
\begin{frame}{Exemple reformulé}
  \begin{center}
    \mintedpycode{python/decorators/example}
    {\Huge =}
    \mintedpycode{python/decorators/example-reformulated}
  \end{center}
\end{frame}
...
\begin{frame}{Définition d'un décorateur}
  \mintedpycode{python/decorators/definition}
\end{frame}

\begin{frame}{Définition d'un décorateur avec arguments}
  \mintedpycode{python/decorators/definition-args}
\end{frame}

\begin{frame}{Utilisation de plusieurs décorateurs}
  \begin{center}
    \mintedpycode{python/decorators/multiple}
    {\Huge =}
    \mintedpycode{python/decorators/multiple-equivalent}
  \end{center}
\end{frame}
