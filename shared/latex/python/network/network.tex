...
\begin{frame}{Alternatives}
  ...
  \begin{description}
    \item[\bluelink{https://grpc.io/docs/languages/python/}{gRPC}] Protocole de sérialisation binaire extrêmement performant
    \item[HTTP] Avec par exemple \bluelink{https://flask.palletsprojects.com/}{Flask}
  \end{description}
\end{frame}
