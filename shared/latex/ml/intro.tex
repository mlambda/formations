\begin{frame}{Un domaine vaste}
  \V{"plt/data-science" | image("th", 0.7)}
\end{frame}

\begin{frame}{Hiérarchie des noms}
  \V{"tikz/ml/ia-ml-deep" | image("th", 0.8)}
\end{frame}
...
\begin{frame}{Ingénierie}
  \V{"tikz/ml/ml-ingenierie" | image("th", 0.75)}
\end{frame}
...
\begin{frame}{Matière première~: les données}
  \begin{columns}
    \begin{column}{.48\textwidth}
      \V{"tikz/ml/data-unsupervised" | image("th", 0.6)}
    \end{column}
    \begin{column}{.52\textwidth}
      \V{"tikz/ml/data-supervised" | image("th", 0.6)}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Apprentissage par Renforcement}
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \V{"img/chess" | image("tw", 0.9)}
    \end{column}
    \begin{column}{0.5\textwidth}
      \V{"img/darpa-2007" | image("tw", 0.9)}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Exemple --- Apprentissage par renforcement}
  \V{"img/car-dashboard" | image("tw", 0.8)}
\end{frame}

\begin{frame}{Topologie du domaine}
  \V{"tikz/ml-illustration" | image("tw", 0.8)}
\end{frame}
