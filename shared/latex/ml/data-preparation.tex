...
\begin{frame}{Outils — dist plot}
  \V{["img/distplot-nzmog", "th", 0.7] | image}
\end{frame}

\begin{frame}{Outils — qq plot}
  \V{["img/qqplot-nzmog", "th", 0.5] | image}
...
\begin{frame}{Outils — bar plot}
  \V{["img/barplot-nzmog", "th", 0.7] | image}
\end{frame}

\begin{frame}{Outils — scatter plot}
  \V{["img/scatter-nzmog", "th", 0.7] | image}
\end{frame}

\begin{frame}{Outils — violin plot}
  \V{["img/violinplot-nzmog", "th", 0.7] | image}
\end{frame}
...
\begin{frame}{Outils — correlation matrix}
  \V{["img/corrmat-nzmog", "th", 0.7] | image}
\end{frame}
