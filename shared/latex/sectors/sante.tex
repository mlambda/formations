...
\begin{frame}{Diagnostique}
  ...
  \begin{minipage}[c]{0.34\linewidth}
    \V{["img/diagramme-oeil", "tw", 1] | image}
  \end{minipage}\hfill
\end{frame}
...
\begin{frame}{Thérapie}
  ...
  \newline
  \begin{minipage}[c]{0.49\linewidth}
    \V{["img/adn-big-data", "tw", 0.8] | image}
  \end{minipage}\hfill
  \begin{minipage}[c]{0.49\linewidth}
    \V{["img/big-data-documents", "tw", 0.8] | image}
  \end{minipage}\hfill
\end{frame}
...
\begin{frame}{Thérapie}
  ...
  \V{["img/molecule-discovery", "th", 0.65] | image}
\end{frame}

\begin{frame}{Thérapie}
  Modélisation de molécules (DeepMind)
  \V{["img/alphafold", "tw", 1] | image}
\end{frame}
...
\begin{frame}{Thérapie}
  ...
  \end{minipage}
  \begin{minipage}{0.49\linewidth}
    \V{["img/robot-chirurgien", "th", 0.7] | image}
  \end{minipage}
\end{frame}

\begin{frame}{Thérapie}
  Lunettes pour aveugles (Panda guide, OrCam Technologies)
  \V{["img/lunettes-pour-aveugle", "tw", 0.8] | image}
\end{frame}
