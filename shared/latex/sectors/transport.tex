\begin{frame}{Voiture autonome}
  \V{["img/voiture-autonome-roborace", "tw", 0.9] | image}
\end{frame}
...
\begin{frame}{Voiture autonome ⋅ Caractéristiques}
  ...
  \end{description}
  \V{["img/voiture-autonome-navya", "th", 0.6] | image}
\end{frame}
...
\begin{frame}{Voiture autonome ⋅ Capteurs}
  \V{["img/voiture-autonome-capteurs", "tw", 0.9] | image}
\end{frame}
...
\begin{frame}{Transport ferroviaire}
  ...
  \end{itemize}
  \V{["img/rail-defects-detection", "tw", 0.7] | image}
\end{frame}
