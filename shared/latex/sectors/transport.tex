...
\begin{frame}
  ...
  \end{center}
  \V{["img/voiture-autonome-navya", "tw", 1] | image}
\end{frame}
...
\begin{frame}
  ...
  \V{["img/darpa-grand-challenge", "tw", 0.6] | image}
\end{frame}
...
\begin{frame}
  ...
  \V{["img/darpa-urban-challenge", "tw", 0.8] | image}
\end{frame}
...
\begin{frame}
  ...
  \V{["img/uber-crash-velo", "tw", 0.7] | image}
\end{frame}
...
\begin{frame}
  ...
  \V{["img/train-aiguillage", "tw", 0.8] | image}
\end{frame}
