...
\begin{frame}{Outils --- Chronogramme}
  ...
  \imgtw{time-serie-chronogramme}{0.9}
\end{frame}
...
\begin{frame}{Outils --- Lag plot}
  ...
  \begin{minipage}[l]{0.499\linewidth}
    \imgtw{lag-plot-linear}{0.7}
    \imgtw{lag-plot-sinusoidal}{0.7}
  \end{minipage}\hfill
  \begin{minipage}[l]{0.499\linewidth}
    \imgtw{lag-plot-white-noise}{0.6}
    \imgtw{lag-plot-uniform-noise}{0.6}
  \end{minipage}\hfill
\end{frame}
...
\begin{frame}{Premières approches }
  \imgth{time-serie-decomposition}{0.9}
\end{frame}
...
\begin{frame}{ARMA --- Introduction}
  ...
  \imgtw{processus-non-stationnaires}{0.9}
\end{frame}
