...
\begin{frame}{Outils --- Chronogramme}
  ...
  \V{["img/time-serie-chronogramme", "tw", 0.9] | image}
\end{frame}
...
\begin{frame}{Outils --- Lag plot}
  ...
  \begin{minipage}[l]{0.499\linewidth}
    \V{["img/lag-plot-linear", "tw", 0.7] | image}
    \V{["img/lag-plot-sinusoidal", "tw", 0.7] | image}
  \end{minipage}\hfill
  \begin{minipage}[l]{0.499\linewidth}
    \V{["img/lag-plot-white-noise", "tw", 0.6] | image}
    \V{["img/lag-plot-uniform-noise", "tw", 0.6] | image}
  \end{minipage}\hfill
\end{frame}
...
\begin{frame}{Premières approches }
  \V{["img/time-serie-decomposition", "th", 0.9] | image}
\end{frame}
...
\begin{frame}{ARMA --- Introduction}
  ...
  \V{["img/processus-non-stationnaires", "tw", 0.9] | image}
\end{frame}
