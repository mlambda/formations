...
\begin{frame}{Analyse Factorielle des Correspondances (AFC)}
  ...
  \begin{minipage}{0.45\linewidth}
    \V{"tikz/dimensionality-reduction/afc" | image("tw", 1.0)}
  \end{minipage}
  \hfill
...
\begin{frame}{AFC --- Probabilités}
  \begin{minipage}{0.45\linewidth}
    \V{"tikz/dimensionality-reduction/afc-proba" | image("tw", 1.0)}
  \end{minipage}
  \hfill
  \begin{minipage}{0.49\linewidth}
...
\begin{frame}{AFC --- Profils ligne et colonne}
  \begin{minipage}{0.45\linewidth}
    \V{"tikz/dimensionality-reduction/afc-profil-ligne" | image("tw", 1.0)}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\linewidth}
    \V{"tikz/dimensionality-reduction/afc-profil-colonne" | image("tw", 1.0)}
  \end{minipage}
...
\begin{frame}{Analyse des Correspondances Multiples (ACM)}
  ...
  \begin{center}
    \V{"tikz/dimensionality-reduction/acm" | image("th", 0.5)}
  \end{center}
