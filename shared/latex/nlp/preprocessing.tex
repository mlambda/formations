...
\begin{frame}{Étiquetage morpho-syntaxique}
  \V{["pos-tagging", "tw", 0.8] | image}
\end{frame}

\begin{frame}{Reconnaissance d'entités nommées}
  \V{["named-entity-recognition", "tw", 0.8] | image}
\end{frame}

\begin{frame}{Analyse syntaxique}
  \V{["parse-tree", "tw", 0.8] | image}
\end{frame}
