\begin{frame}{Qu'est-ce que la quantization~?}
  \begin{itemize}
...
\begin{frame}{Pour aller plus loin}
  \begin{itemize}
    \item \bluelink{https://www.tensorflow.org/model\_optimization/guide/quantization/post\_training}{Guide sur la quantization post-entraînement}
    \item \bluelink{https://www.tensorflow.org/model\_optimization/guide/quantization/training}{Guide sur l'entraînement adapté à la quantization}
