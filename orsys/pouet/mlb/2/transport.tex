...
\begin{frame}
  ...
  Premières courses sans ``chauffeurs''
  \imgtw[0.8]{waymo-one}
\end{frame}
...
\begin{frame}
  ...
  \newline
  Au 2ème accident Autopilot avait parcourus 210 Millions de kilomètres \\
  Au 5ème accident (2019), plus d'un milliard et demi de kilomètres
  \newline
  1 seul (Uber mars 2018) ou le pilote automatique est mis en cause
