...
\begin{frame}
  ...
  \begin{itemize}
    \item \bluelink{https://projector.tensorflow.org/}{Visualisation de l'espace word2vec}
    \item \bluelink{http://vectors.nlpl.eu/repository/}{Word Embeddings à télécharger}
  \end{itemize}
\end{frame}
