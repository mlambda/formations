...
\begin{frame}
  ...
  \begin{itemize}[<+->]
  \item \red{variables confondantes}
  \item \red{biais statistiques} (sélection,
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
  \item anecdote $\neq$ bonne hypothèse. \green{Pourquoi ?}
  \item anecdote $\neq$ bonne prédiction
...
\begin{frame}
  ...
  \item \red{attention, il faut pouvoir inverser ce préprocessing !}
  \end{itemize}
\end{frame}
