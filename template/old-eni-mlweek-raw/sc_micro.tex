...
\begin{frame}
  ...
  \centerline{\includegraphics[width=0.5\linewidth]{/home/fmg/formations-img/fair}}
...
\begin{frame}
  ...
  \begin{textblock*}{8cm}(0cm, -2.5cm)
    \includegraphics[width=\linewidth]{/home/fmg/formations-img/atari}
  \end{textblock*}

  \begin{textblock*}{8cm}(3cm, -0.5cm)
    \includegraphics[width=\linewidth]{/home/fmg/formations-img/minecraft}
  \end{textblock*}
...
\begin{frame}
  ...
  \centerline{\includegraphics[width=0.7\linewidth]{/home/fmg/formations-img/starcraft_group}}  
...
\begin{frame}
  ...
  \centerline{\includegraphics[width=0.7\linewidth]{/home/fmg/formations-img/starcraft_squad}}  
...
\begin{frame}
  ...
  \begin{textblock*}{5cm}(0cm, -3cm)
    \includegraphics[width=\linewidth]{/home/fmg/formations-img/starcraft_m5v5}
  \end{textblock*}

  \begin{textblock*}{5cm}(6cm, -3cm)
    \includegraphics[width=0.9\linewidth]{/home/fmg/formations-img/starcraft_m15v16}
  \end{textblock*}

  \begin{textblock*}{5cm}(0cm, 1cm)
    \includegraphics[width=\linewidth]{/home/fmg/formations-img/starcraft_w15v17}
  \end{textblock*}

  \begin{textblock*}{5cm}(6cm, 1cm)
    \includegraphics[width=0.9\linewidth]{/home/fmg/formations-img/starcraft_mix_dragoon_zealot}
  \end{textblock*}
...
\begin{frame}
  ...
  \begin{textblock*}{8.25cm}(1.3cm, -2cm)
    \centerline{\def\svgwidth{\columnwidth}\input{/home/fmg/formations-img/chaine_markov.tex}}
  \end{textblock*}
  ...
  % \centerline{\includegraphics[width=0.9\linewidth]{/home/fmg/formations-img/mdp}}
...
\begin{frame}
  ...
  \begin{textblock*}{11cm}(0cm, -3cm)
    \centerline{\includegraphics[width=0.9\linewidth]{/home/fmg/formations-img/chaine_markov_greedy.png}}
  \end{textblock*}
...
\begin{frame}
  ...
  \centerline{\includegraphics[width=\linewidth]{/home/fmg/formations-img/model2}}  
...
\begin{frame}
  ...
  \centerline{\includegraphics[width=\linewidth]{/home/fmg/formations-img/mise_a_jour}}  
...
\begin{frame}
  ...
  \centerline{\includegraphics[width=1.1\linewidth]{/home/fmg/formations-img/results_fig}}
...
\begin{frame}
  ...
  \centerline{\includegraphics[width=1.1\linewidth]{/home/fmg/formations-img/results_tab1}}
...
\begin{frame}
  ...
  \centerline{\includegraphics[width=0.7\linewidth]{/home/fmg/formations-img/results_tab2}}
...
\begin{frame}
  ...
  \centerline{\includegraphics[width=1.1\linewidth]{/home/fmg/formations-img/winrate}}
