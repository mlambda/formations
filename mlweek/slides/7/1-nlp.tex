...
\begin{frame}
  \frametitle{Traitement du langage : WordNet}
  \imgth[0.7]{wordnet-1}  
  Projet sur le français : WOLF (Wordnet Libre du Français) 
\end{frame}

\begin{frame}
  \frametitle{Traitement du langage : DBpedia}
  \imgth[1]{dbpedia}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \href{http://vectors.nlpl.eu/repository/}{\blue{Word Embeddings à télécharger}}
  \end{center}
\end{frame}
