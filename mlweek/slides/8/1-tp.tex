...
\begin{frame}
  ...
  \begin{center}
    \blue{\href{https://drive.google.com/open?id=1wS56Bvj0KNGqMHIviwd2Y9uwYnUYkT5b}{Colab-CNN-landscape}}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  N'oubliez pas d'en créer une copie sur votre google drive avant de commencer le TP
  \begin{center}
    \blue{\href{https://drive.google.com/open?id=1o-bJu3E70FwL9twPU3R4L9epTL9rE3dI}{Colab-CNN-emotions}}
  \end{center}
\end{frame}
