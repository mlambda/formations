...
\begin{frame}
  \frametitle{Diagnostique et machine learning}
  Toutes les pathologies sont potentiellement apprenables
    \begin{itemize}
...
\begin{frame}
  \frametitle{Diagnostique et machine learning}
  \begin{center}
    \textbf{\underline{Quelques Startups de la génomique}}
  \end{center}
  Collecte de données de santé :
  \begin{itemize}
  \item Portable Genomics
  \item iCarbonX
  \end{itemize}
  Analyse des corrélations gènes - phénotype
  \begin{itemize}
  \item Pathway Genomics
  \item Deep Genomics
  \item Sophia Genetics
  \item Ginger.io
  \item Lumiata
  \end{itemize}
\end{frame}
