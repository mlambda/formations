...
\begin{document}
  \begin{tikzpicture}[x=2cm]
    ...
    \foreach \y in {1,...,5} {
        \node[output] (O\y) at (5, 3 - \y) {$\hat{x}_\y$};
    }
    % Arrows
    \foreach \i in {1,...,5} {
        \foreach \j in {1,...,4} {
    ...
    % Text above
    \node at (1.2, 3) {\textcolor{DeepSpaceSparkle}{\textbf{Means}}};
    \node at (1, -3) {\textcolor{DeepSpaceSparkle}{\textbf{Variances}}};
    \node[align=center] at (3, -2) {\textcolor{DeepSpaceSparkle}{\textbf{Generated}}\\\textcolor{DeepSpaceSparkle}{\textbf{vector}}};
  \end{tikzpicture}
\end{document}
