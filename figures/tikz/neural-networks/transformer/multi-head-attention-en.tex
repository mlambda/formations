...
%Start drawing the thing...    
    ...
    \node[self-attention,minimum width=6cm] (att5) at (3.0,3.0) {$\text{attention head}_5$};
    \node[self-attention,minimum width=6cm] (att4) at (2.5,2.5) {$\text{attention head}_4$};
    \node[self-attention,minimum width=6cm] (att3) at (2.0,2.0) {$\text{attention head}_3$};
    \node[self-attention,minimum width=6cm] (att2) at (1.5,1.5) {$\text{attention head}_2$};
    \node[self-attention,minimum width=6cm] (att1) at (1.0,1.0) {$\text{attention head}_1$};
    ...
    \node[feedforward,minimum width=6cm] (feedforward) at (2.2,8.0) {dense layer};
