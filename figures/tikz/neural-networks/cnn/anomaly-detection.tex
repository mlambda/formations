...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%   
\node[canvas is zy plane at x=0] (alan) at (0,0,0) {\includegraphics[width=12cm,height=12cm]{img/sub-img/tile-crack.png}};
...
\node[canvas is zy plane at x=4] (alan2) at (c5-east) {\includegraphics[width=12cm,height=12cm]{img/sub-img/tile-crack-mask.png}};
