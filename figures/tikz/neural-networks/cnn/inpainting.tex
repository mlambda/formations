...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%   
\node[canvas is zy plane at x=0] (alan) at (0,0,0) {\includegraphics[width=9cm,height=9cm]{img/sub-img/toothbrush-masked-1.png}};
...
\node[canvas is zy plane at x=4] (alan2) at (c5-east) {\includegraphics[width=9cm,height=9cm]{img/sub-img/toothbrush.png}};
